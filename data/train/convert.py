...
with open('harmful_simple_adaptive.json', 'r', encoding='utf-8') as f:
    data = json.load(f)

# Convert to JSONL format
with open('harmful_simple_adaptive.jsonl', 'w', encoding='utf-8') as f:
...
print(f"Conversion complete! Created harmful_simple_adaptive.jsonl with {len(data)} entries")
